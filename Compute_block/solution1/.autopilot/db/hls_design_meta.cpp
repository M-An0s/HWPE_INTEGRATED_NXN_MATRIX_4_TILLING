...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("buffer_1_q0", 64, hls_in, 0, "ap_memory", "in_data", 1),
	Port_Property("buffer_1_address1", 3, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("buffer_1_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("buffer_1_q1", 64, hls_in, 0, "ap_memory", "in_data", 1),
