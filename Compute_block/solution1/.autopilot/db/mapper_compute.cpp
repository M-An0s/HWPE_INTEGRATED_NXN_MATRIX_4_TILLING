...
__xlx_buffer_1__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_buffer_1)[i]);
}
  int __xlx_size_param_buffer_1 = 8;
  int __xlx_offset_param_buffer_1 = 0;
  int __xlx_offset_byte_param_buffer_1 = 0*8;
