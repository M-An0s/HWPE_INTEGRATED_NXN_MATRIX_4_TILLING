...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a16struct.ap_int<32>.5"([16 x %"struct.ap_int<32>"]* noalias "unpacked"="0", [16 x i32]* noalias nocapture readonly align 512 "unpacked"="1.0.0.0") unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a8struct.ap_int<64>.29"([8 x i64]* noalias nocapture align 512 "unpacked"="0.0.0.0", [8 x %"struct.ap_int<64>"]* noalias readonly "unpacked"="1") unnamed_addr #3 {
entry:
