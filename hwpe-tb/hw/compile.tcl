...
set ROOT "/home/pulp1/HLS_corrected/hwpe-tb/hw"
...
if {[catch {vlog -incr -sv \
    ...
    +define+TARGET_TEST \
    +define+TARGET_VSIM \
    "$ROOT/ips/tech_cells_generic/src/rtl/tc_sync.sv"
}]} {return 1}
...
if {[catch {vlog -incr -sv \
    ...
    "$ROOT/ips/hwpe-mac-engine/rtl/in_Mem.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/res_Mem.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/stream_fifo.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/slave_res_Mem.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/cont.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_compute_Pipeline_VITIS_LOOP_60_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_compute_Pipeline_VITIS_LOOP_79_2.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_flow_control_loop_pipe_sequential_init.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_mac_muladd_16ns_16ns_32ns_32_4_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_mac_muladd_16ns_16ns_32ns_33_4_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_mul_mul_16ns_16ns_32_4_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_mux_32_16_1_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_mux_42_16_1_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave_compute_slave_Pipeline_compute_rows_VITIS_LOOP_69_5.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave_compute_slave_Pipeline_VITIS_LOOP_53_1_VITIS_LOOP_54_2.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave_compute_slave_Pipeline_VITIS_LOOP_60_3_VITIS_LOOP_61_4.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave_flow_control_loop_pipe_sequential_init.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave_mac_muladd_16ns_16ns_32ns_32_4_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave_mul_mul_16ns_16ns_32_4_1.v" \
    "$ROOT/ips/hwpe-mac-engine/rtl/compute_slave_mux_42_16_1_1.v" \
