...
(
  ...
  logic [31:0] s1_fwd2_dout;   logic s1_fwd2_empty_n;  logic s1_fwd2_read;
  // --- SLAVE 1 result memory write ---
  logic [3:0]  s1_res_addr;    logic s1_res_ce;  logic s1_res_we;  logic [31:0] s1_res_d;
 
  // --- SLAVE 2 forward-in streams (FIFO read side) ---
  logic [31:0] s2_fwd1_dout;   logic s2_fwd1_empty_n;  logic s2_fwd1_read;
  logic [31:0] s2_fwd2_dout;   logic s2_fwd2_empty_n;  logic s2_fwd2_read;
