...
The original hwpe-tb mac_engine has been removed. The original fsm is kept for interfacing with stream strides and the control module. Other than that all the .v files are  generated by the HLS in this github, as well as some memory modules. You can find all the connection in mac_top
