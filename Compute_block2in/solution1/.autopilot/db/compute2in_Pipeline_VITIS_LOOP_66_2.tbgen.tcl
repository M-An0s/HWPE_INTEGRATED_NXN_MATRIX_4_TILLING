set moduleName compute2in_Pipeline_VITIS_LOOP_66_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {compute2in_Pipeline_VITIS_LOOP_66_2}
...
set portList { 
	...
	{ buffer_a_address0 sc_out sc_lv 3 signal 33 } 
	{ buffer_a_ce0 sc_out sc_logic 1 signal 33 } 
	{ buffer_a_q0 sc_in sc_lv 32 signal 33 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_1ns_16ns_32_1_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_1ns_16ns_17ns_33_4_1_U2", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	buffer_a { ap_memory {  { buffer_a_address0 mem_address 1 3 }  { buffer_a_ce0 mem_ce 1 1 }  { buffer_a_q0 in_data 0 32 } } }
...
set C_modelArgMapList {[ 
	{ "Name" : "REG_V_31", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "REG_V_1", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "REG_V", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_8", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "buffer_a", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ REG_V_1 sc_in sc_lv 16 signal 30 } 
	{ REG_V sc_in sc_lv 16 signal 31 } 
	{ tmp_8 sc_in sc_lv 3 signal 32 } 
	{ buffer_a_address0 sc_out sc_lv 3 signal 33 } 
	{ buffer_a_ce0 sc_out sc_logic 1 signal 33 } 
	{ buffer_a_q0 sc_in sc_lv 32 signal 33 } 
	{ buffer_b_address0 sc_out sc_lv 3 signal 34 } 
	{ buffer_b_ce0 sc_out sc_logic 1 signal 34 } 
	{ buffer_b_q0 sc_in sc_lv 32 signal 34 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "REG_V_1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "REG_V_1", "role": "default" }} , 
 	{ "name": "REG_V", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "REG_V", "role": "default" }} , 
 	{ "name": "tmp_8", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "tmp_8", "role": "default" }} , 
 	{ "name": "buffer_a_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "buffer_a", "role": "address0" }} , 
 	{ "name": "buffer_a_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer_a", "role": "ce0" }} , 
 	{ "name": "buffer_a_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer_a", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	REG_V_1 { ap_none {  { REG_V_1 in_data 0 16 } } }
	REG_V { ap_none {  { REG_V in_data 0 16 } } }
	tmp_8 { ap_none {  { tmp_8 in_data 0 3 } } }
	buffer_a { ap_memory {  { buffer_a_address0 mem_address 1 3 }  { buffer_a_ce0 mem_ce 1 1 }  { buffer_a_q0 in_data 0 32 } } }
	buffer_b { ap_memory {  { buffer_b_address0 mem_address 1 3 }  { buffer_b_ce0 mem_ce 1 1 }  { buffer_b_q0 in_data 0 32 } } }
